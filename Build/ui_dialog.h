...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        layoutWidget->setGeometry(QRect(20, 450, 231, 41));
        horizontalLayout_2 = new QHBoxLayout(layoutWidget);
        horizontalLayout_2->setSpacing(6);
        horizontalLayout_2->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_2->setObjectName(QStringLiteral("horizontalLayout_2"));
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        subitButton = new QPushButton(layoutWidget);
        subitButton->setObjectName(QStringLiteral("subitButton"));

        horizontalLayout_2->addWidget(subitButton);
        ...
        layoutWidget1->setGeometry(QRect(20, 40, 322, 116));
        gridLayout = new QGridLayout(layoutWidget1);
        gridLayout->setSpacing(6);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        alert_Iz = new Alert(layoutWidget1);
        alert_Iz->setObjectName(QStringLiteral("alert_Iz"));
        alert_Iz->setEnabled(true);
        QSizePolicy sizePolicy1(QSizePolicy::Fixed, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(alert_Iz->sizePolicy().hasHeightForWidth());
        alert_Iz->setSizePolicy(sizePolicy1);
        alert_Iz->setMinimumSize(QSize(168, 34));

        gridLayout->addWidget(alert_Iz, 2, 2, 1, 1);

        alert_Ix = new Alert(layoutWidget1);
        alert_Ix->setObjectName(QStringLiteral("alert_Ix"));
        alert_Ix->setEnabled(true);
        sizePolicy1.setHeightForWidth(alert_Ix->sizePolicy().hasHeightForWidth());
        alert_Ix->setSizePolicy(sizePolicy1);
        ...
        alert_Iy = new Alert(layoutWidget1);
        alert_Iy->setObjectName(QStringLiteral("alert_Iy"));
        alert_Iy->setEnabled(true);
        sizePolicy1.setHeightForWidth(alert_Iy->sizePolicy().hasHeightForWidth());
        alert_Iy->setSizePolicy(sizePolicy1);
        ...
        input_Iz = new PositiveNumberInput(layoutWidget1);
        input_Iz->setObjectName(QStringLiteral("input_Iz"));
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(input_Iz->sizePolicy().hasHeightForWidth());
        input_Iz->setSizePolicy(sizePolicy2);
        ...
        input_Ix = new PositiveNumberInput(layoutWidget1);
        input_Ix->setObjectName(QStringLiteral("input_Ix"));
        sizePolicy2.setHeightForWidth(input_Ix->sizePolicy().hasHeightForWidth());
        input_Ix->setSizePolicy(sizePolicy2);
        input_Ix->setAutoFillBackground(false);
        input_Ix->setClearButtonEnabled(false);

        gridLayout->addWidget(input_Ix, 0, 1, 1, 1);

        input_Iy = new PositiveNumberInput(layoutWidget1);
        input_Iy->setObjectName(QStringLiteral("input_Iy"));
        sizePolicy2.setHeightForWidth(input_Iy->sizePolicy().hasHeightForWidth());
        input_Iy->setSizePolicy(sizePolicy2);

        gridLayout->addWidget(input_Iy, 1, 1, 1, 1);

        layoutWidget2 = new QWidget(Dialog);
        layoutWidget2->setObjectName(QStringLiteral("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(20, 230, 239, 116));
        ...
        label_2->raise();
        layoutWidget->raise();
        QWidget::setTabOrder(subitButton, pauseButton);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        subitButton->setText(QApplication::translate("Dialog", "\320\235\320\260\321\207\320\260\321\202\321\214", 0));
